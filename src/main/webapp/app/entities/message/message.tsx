          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('lkpMessageTypeId')}>
                  Lkp Message Type Id <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('senderUserId')}>
                  Sender User Id <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('senderAlias')}>
                  Sender Alias <FontAwesomeIcon icon="sort" />
                </th>
            ...
            <tbody>
              {messageList.map((message, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{message.lkpMessageTypeId}</td>
                  <td>{message.senderUserId}</td>
                  <td>{message.senderAlias}</td>
                  <td>{message.createdBy}</td>
                  <td>{message.dateCreated ? <TextFormat type="date" value={message.dateCreated} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{message.order ? <Link to={`order/${message.order.id}`}>{message.order.id}</Link> : ''}</td>
