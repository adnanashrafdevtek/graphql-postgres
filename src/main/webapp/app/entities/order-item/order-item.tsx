          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('catalogItemId')}>
                  Catalog Item Id <FontAwesomeIcon icon="sort" />
                </th>
                <th>
            ...
            <tbody>
              {orderItemList.map((orderItem, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    {orderItem.dateCreated ? <TextFormat type="date" value={orderItem.dateCreated} format={APP_DATE_FORMAT} /> : null}
                  </td>
                  <td>
                    {orderItem.dateUpdated ? <TextFormat type="date" value={orderItem.dateUpdated} format={APP_DATE_FORMAT} /> : null}
                  </td>
                  <td>{orderItem.catalogItemId}</td>
